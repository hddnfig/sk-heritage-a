    ...
    <div className="hs-page">
      <header className="hs-header">
        ...
        <nav className="hs-nav" aria-label="주요 메뉴">
          <a href="#" onClick={(event) => event.preventDefault()}>그룹역사</a>
          <a className="is-active" href="#" aria-current="page" onClick={(event) => event.preventDefault()}>H.Space</a>
          <a href="#" onClick={(event) => event.preventDefault()}>전시/소장품</a>
          <a href="#" onClick={(event) => event.preventDefault()}>뉴스보드</a>
        </nav>
      </header>
